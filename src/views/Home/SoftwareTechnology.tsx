...
const SoftwareTechnology = () => {
  ...
  return (
    <div className="my-6">
      ...
      <div className="flex bg-gray-100 border border-gray-300 my-6">
        {tabs.map((tab) => (
          <button
            key={tab}
            onClick={() => setActiveTab(tab)}
            className={`flex-1 text-center px-4 py-2 font-medium relative transition-colors duration-200 cursor-pointer ${
              activeTab === tab
                ? "bg-white border-t-4 border-[var(--primary-color)] text-[var(--primary-color)] -mb-[1px]"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 justify-items-center items-center p-4 bg-white border-l border-r border-b border-gray-300">
